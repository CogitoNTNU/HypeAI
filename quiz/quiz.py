...
def generate_quiz(knowledge_text, model="gpt-3.5-turbo", max_tokens=500):
    """
    ...
    system_prompt = "Your job is to generate 5 extremely concise quiz questions and answers based on the following knowledge."
